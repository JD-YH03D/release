  ...
  return (
    <div className="min-h-screen bg-slate-950 text-slate-200 overflow-x-hidden noise">
              ...
              <nav className="flex flex-col py-3 px-4 space-y-0.5">
                {[
                  ...
                  <a
                    ...
                    className="flex items-center space-x-3 text-slate-400 hover:text-white active:bg-slate-800/50 hover:bg-slate-800/30 px-4 py-2.5 rounded-xl text-sm font-semibold transition-colors"
                    onClick={(e) => { if (item.href.startsWith("#")) { e.preventDefault(); scrollToSection(item.href); } }}
                  >
      ...
      <main className="relative z-10">
        ...
        >
          ...
          <div className="w-full mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl relative z-10">
            <div className="flex flex-col lg:flex-row items-center gap-6 sm:gap-8 lg:gap-12 xl:gap-16 pt-16 sm:pt-20 pb-6 sm:pb-8">
              ...
              >
                {/* Badge */}
                <motion.div
                  className="inline-flex items-center space-x-2 bg-blue-500/[0.08] border border-blue-500/20 px-3 sm:px-4 py-1.5 sm:py-2 rounded-full mb-3 sm:mb-3"
                ...
                {/* Heading */}
                <motion.h1
                  className="text-[2.5rem] leading-[1.05] sm:text-5xl md:text-6xl lg:text-7xl font-black mb-2 sm:mb-2.5 tracking-tight"
                ...
                <motion.p
                  className="text-slate-400 text-base sm:text-lg md:text-xl mb-4 sm:mb-5 max-w-xl leading-relaxed mx-auto lg:mx-0"
                ...
                {/* Stats */}
                <motion.div
                  className="mt-5 sm:mt-6 lg:mt-7 grid grid-cols-2 sm:grid-cols-4 gap-2 sm:gap-3"
                  initial={{ opacity: 0, y: 20 }}
                  animate={{ opacity: 1, y: 0 }}
                  transition={{ delay: 1 }}
                >
                  {stats.map((s) => (
                    <div key={s.label} className="text-center lg:text-left p-1 sm:p-0">
                      <div className="flex items-center justify-center lg:justify-start space-x-1.5 sm:space-x-2">
                        <s.icon size={11} className="text-blue-400/60" />
                        <span className="text-xl sm:text-2xl font-black text-white leading-none">
                          <StatCounter value={s.value} suffix={s.suffix} />
                        </span>
                      </div>
                      <span className="text-[9px] sm:text-[10px] text-slate-500 uppercase tracking-wider font-semibold leading-tight">{s.label}</span>
                    </div>
                  ))}
                </motion.div>
              </motion.div>
              ...
              >
                <motion.div style={{ rotateX: heroTilt.springX, rotateY: heroTilt.springY, transformStyle: "preserve-3d" }} className="relative">
                  ...
                  <div className="relative glass-strong rounded-2xl p-4 xl:p-5 shadow-2xl shadow-slate-950/50">
        ...
        {/* ── DIRECTORY ── */}
        <section id="directory" className="py-8 sm:py-10 md:py-14 lg:py-16 relative">
          <div className="mx-auto px-4 sm:px-6 lg:px-8 max-w-6xl">
            <motion.div
              className="flex flex-col sm:flex-row sm:items-end justify-between mb-5 sm:mb-6 lg:mb-8 gap-2 sm:gap-3"
              initial={{ opacity: 0, y: 30 }}
            ...
            <AnimatePresence mode="wait">
              ...
              >
                {activeTab === "production" && (
                  <div className="space-y-4 sm:space-y-5">
                    ...
                    <motion.article className="glass rounded-xl sm:rounded-2xl overflow-hidden group card-lift hover:border-emerald-500/20" initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}>
                      <div className="relative bg-gradient-to-r from-slate-900/80 to-slate-800/40 px-4 sm:px-6 py-3 sm:py-3.5 border-b border-slate-700/20 overflow-hidden">
                      ...
                      <div className="sm:hidden p-2.5 space-y-1.5">
                        <div className="flex items-center justify-between p-2.5 rounded-xl bg-slate-800/20 border border-slate-700/15">
                      ...
                      <div className="hidden sm:block overflow-x-auto">
                        <table className="w-full text-left text-sm">
                          <thead className="text-[9px] uppercase tracking-[0.15em] text-slate-500 bg-slate-950/30">
                            <tr>
                              <th className="px-4 md:px-6 py-2 md:py-2.5 font-bold border-b border-slate-700/20">Build Name</th>
                    ...
                    {/* Coming Soon */}
                    <motion.div className="border-2 border-dashed border-slate-800/40 p-6 sm:p-8 lg:p-10 rounded-xl sm:rounded-2xl flex flex-col items-center justify-center text-center group hover:border-blue-500/20 transition-all duration-500 overflow-hidden relative"
                ...
                {activeTab === "legacy" && (
                  <motion.div className="py-10 sm:py-12 flex flex-col items-center justify-center text-center" initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
        ...
        <section id="documentation" className="py-8 sm:py-10 md:py-14 lg:py-16 relative">
          <div className="mx-auto px-4 sm:px-6 lg:px-8 max-w-6xl">
            ...
            {/* Feature Cards */}
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 lg:gap-5 mb-6 sm:mb-7 lg:mb-8">
              {[
                ...
                <motion.div key={item.title} className="glass rounded-xl sm:rounded-2xl p-3 sm:p-4 lg:p-5 card-lift transition-all group"
                  initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: i * 0.08 }}>
                  <div className={`w-9 h-9 sm:w-10 sm:h-10 lg:w-11 lg:h-11 rounded-lg sm:rounded-xl bg-gradient-to-br ${item.gradient} flex items-center justify-center mb-2 sm:mb-2.5 lg:mb-3 group-hover:scale-110 transition-transform`}>
                    <item.icon size={16} className={`${item.color} sm:hidden`} />
                    <item.icon size={18} className={`${item.color} hidden sm:block`} />
                  </div>
                  <h4 className="text-white font-bold text-[11px] sm:text-xs lg:text-sm mb-0.5 sm:mb-1">{item.title}</h4>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-5 gap-3 sm:gap-4">
              ...
              {/* Right Side */}
              <motion.div className="lg:col-span-2 space-y-2 sm:space-y-3"
                ...
                <a href="https://github.com/JD-YH03D/Releases-Published/issues" target="_blank" rel="noopener noreferrer"
                  className="glass rounded-xl sm:rounded-2xl p-3 sm:p-4 card-lift hover:border-red-500/20 transition-all block group">
                  <div className="flex items-center space-x-3 sm:space-x-4">
      ...
      <footer className="relative z-10 border-t border-slate-800/30 bg-slate-950/80 backdrop-blur-sm">
        <div className="mx-auto px-4 sm:px-6 lg:px-8 max-w-6xl py-5 sm:py-6 lg:py-8">
