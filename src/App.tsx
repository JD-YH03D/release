...
const TampermonkeyIcon = (props: any) => (
  <svg {...props} viewBox="0 0 64 64" fill="none">
    <circle cx="32" cy="32" r="32" fill="#E0A82E" />
    <circle cx="32" cy="32" r="24" fill="#fff" />
    <circle cx="32" cy="32" r="16" fill="#E0A82E" />
...
export default function App() {
  ...
  const [activeTab, setActiveTab] = useState<"production" | "legacy">(
    "production"
  );
  ...
  const keyboardControls = [
    {
      ...
      desc: "Open or close the settings interface",
    },
    {
      key: "V",
      label: "Info Panel",
      desc: "Toggle the location info display",
    },
    {
      key: "M",
      label: "Manual Marker",
      desc: "Place a marker on the game map",
    },
    { key: "X", label: "Refresh", desc: "Reset state for the next round" },
    {
      key: "1",
      label: "Auto Place",
      desc: "Place marker at the exact predicted position",
      isPrimary: true,
    },
    {
      key: "2",
      label: "Safe Place",
      desc: "Place marker with a randomized offset",
      isPrimary: true,
    },
    {
      key: "S",
      label: "Zoom In",
      desc: "Increase the mini-map zoom level",
    },
    {
      key: "A",
      label: "Zoom Out",
      desc: "Decrease the mini-map zoom level",
    },
    {
      key: "C",
      label: "Copy Coords",
    ...
    },
    {
      key: "G",
      label: "Google Maps",
      desc: "Open the current location in Google Maps",
    },
    {
      key: "D",
      label: "Discord",
      desc: "Send the location data to a Discord webhook",
      isDiscord: true,
    },
  ];

  const tampermonkeySteps = [
    {
      step: 1,
      title: "Open Browser Web Store",
      desc: "Navigate to the extension store for your browser. Chrome users go to the Chrome Web Store, Firefox users go to Firefox Add-ons.",
      icon: Globe,
      color: "text-blue-400",
      bg: "bg-blue-500/10",
      border: "border-blue-500/20",
      detail:
        "Open your browser and visit the official extension marketplace. For Chrome: chrome.google.com/webstore. For Firefox: addons.mozilla.org. For Edge: microsoftedge.microsoft.com/addons.",
      link: "https://www.tampermonkey.net/",
      linkLabel: "Visit Tampermonkey.net",
    },
    {
      step: 2,
      title: "Search & Install Tampermonkey",
      desc: 'Search for "Tampermonkey" in the store and click "Add to Browser" or "Install" button.',
      icon: Puzzle,
      color: "text-purple-400",
      bg: "bg-purple-500/10",
      border: "border-purple-500/20",
      detail:
        'In the search bar, type "Tampermonkey" and press Enter. Look for the official extension by Jan Biniok with millions of users. Click "Add to Chrome" (or your browser equivalent) and confirm the installation dialog.',
    ...
    },
    {
      ...
      desc: "Click \"Add Extension\" when the browser asks for permission. Tampermonkey icon will appear in your toolbar.",
      icon: CheckCircle,
      color: "text-emerald-400",
      bg: "bg-emerald-500/10",
      border: "border-emerald-500/20",
      detail:
        'A popup will appear asking to confirm the installation. Click "Add Extension" to proceed. Once installed, you\'ll see the Tampermonkey icon (a circle with two overlapping rings) in your browser toolbar. Pin it for easy access.',
    },
    {
      step: 4,
      title: "Tampermonkey is Ready",
      desc: "The extension is now active. You can now install scripts from Greasy Fork or other trusted sources.",
      icon: Star,
      color: "text-yellow-400",
      bg: "bg-yellow-500/10",
      border: "border-yellow-500/20",
      detail:
        'Click the Tampermonkey icon in your toolbar to open the dashboard. You\'ll see options to create new scripts, manage existing ones, and configure settings. The extension runs in the background and automatically executes scripts on matching websites.',
    },
  ];

  const greasyforkSteps = [
    {
      step: 1,
      title: "Ensure Tampermonkey is Installed",
      desc: "Before installing scripts, make sure Tampermonkey is properly installed and active in your browser.",
      icon: Shield,
      color: "text-emerald-400",
      bg: "bg-emerald-500/10",
      border: "border-emerald-500/20",
      detail:
        "Check that the Tampermonkey icon is visible in your browser toolbar. If it appears greyed out, click it and enable the extension. Without Tampermonkey, you cannot install or run UserScripts.",
    },
    {
      step: 2,
      title: "Go to the Script Page",
      desc: 'Click the "Install" button on any script card above, or browse Greasy Fork directly at greasyfork.org.',
      icon: ExternalLink,
      color: "text-blue-400",
      bg: "bg-blue-500/10",
      border: "border-blue-500/20",
      detail:
        "Each script card in the Directory section above has a green Install button. Clicking it will take you directly to that script's Greasy Fork page. Alternatively, you can browse greasyfork.org to discover more scripts.",
      link: "https://greasyfork.org",
      linkLabel: "Browse Greasy Fork",
    },
    {
      step: 3,
      title: "Click Install This Script",
      desc: 'On the Greasy Fork script page, click the green "Install this script" button to begin installation.',
      icon: Download,
      color: "text-purple-400",
      bg: "bg-purple-500/10",
      border: "border-purple-500/20",
      detail:
        'On the Greasy Fork page, you\'ll find a large green button labeled "Install this script". Click it. Tampermonkey will automatically intercept the installation and open a confirmation dialog showing the script\'s permissions and metadata.',
    },
    {
      step: 4,
      title: "Confirm in Tampermonkey",
      desc: 'A Tampermonkey dialog will open. Review the script details and click "Install" to confirm.',
      icon: Zap,
      color: "text-yellow-400",
      bg: "bg-yellow-500/10",
      border: "border-yellow-500/20",
      detail:
        'The Tampermonkey installation dialog shows the script name, version, author, and required permissions. Review these carefully. Click "Install" to confirm. The script is now active and will run automatically on the specified website. You can manage or disable it anytime from the Tampermonkey dashboard.',
    },
  ];

  const currentSteps =
    activeInstallTab === "tampermonkey" ? tampermonkeySteps : greasyforkSteps;
  ...
  return (
    <div className="min-h-screen bg-slate-950 text-slate-200 overflow-x-hidden">
      ...
      <div className="fixed inset-0 z-0 overflow-hidden" aria-hidden="true">
        ...
        >
          <source
            src="https://github.com/JD-YH03D/Releases-Published/main/public/image/Itachi/background-2.mp4"
            type="video/mp4"
          />
        </video>
            ...
            >
              <div className="bg-slate-900/80 px-6 py-4 border-b border-slate-800 flex justify-between items-center">
                <div className="flex items-center space-x-3">
                  ...
                  <h3
                    id="modal-title"
                    className="font-semibold text-white text-sm tracking-wide uppercase"
                  >
                    GeoGuessr Controls
                  </h3>
                </div>
                ...
                <div className="overflow-hidden border border-slate-800 rounded-xl">
                  <table className="w-full text-left text-xs font-mono">
                    <thead className="bg-slate-900/50 text-slate-500 text-[10px] uppercase tracking-wider">
                      <tr>
                        <th className="px-4 py-3 font-semibold border-b border-slate-800 w-1/4">
                          Key
                        </th>
                        <th className="px-4 py-3 font-semibold border-b border-slate-800 w-1/4">
                          Function
                        </th>
                        <th className="px-4 py-3 font-semibold border-b border-slate-800 hidden sm:table-cell">
                          Description
                        </th>
                      </tr>
                    </thead>
                    <tbody className="divide-y divide-slate-800/50 text-slate-300">
                      {keyboardControls.map((ctrl, i) => (
                        ...
                        >
                          ...
                          <td
                            className={`px-4 py-3 text-xs font-medium ${ctrl.isDiscord ? "text-[#5865F2]" : ctrl.isPrimary ? "text-emerald-400" : "text-white"}`}
                          >
                            {ctrl.label}
                          </td>
        ...
        <div className="container mx-auto px-6 py-4 flex justify-between items-center">
          ...
          >
            <div className="relative">
              <div className="absolute inset-0 bg-blue-500/30 blur-lg rounded-xl opacity-0 group-hover:opacity-100 transition" />
                ...
                <img
                  ...
                  onError={(e) => {
                    (e.target as HTMLImageElement).src =
                      "https://placehold.co/40x40/0f172a/60a5fa?text=JD";
                  }}
                />
              </div>
            </div>
          ...
          >
            ...
            <motion.a
              ...
              className="bg-white/5 hover:bg-white/10 px-4 py-2 rounded-full border border-white/10 text-white transition flex items-center gap-2"
          ...
          <nav className="flex flex-col py-4 px-6 space-y-1">
            {[
              ...
              <a
                key={item.href}
                href={item.href}
                className="text-slate-400 hover:text-white hover:bg-slate-800/50 px-4 py-3 rounded-lg text-sm font-semibold transition-colors flex items-center gap-3"
                onClick={(e) => {
                  if (item.href.startsWith("#")) {
                    e.preventDefault();
                    scrollToSection(item.href);
      ...
      <main className="container mx-auto px-6 max-w-6xl relative z-10">
        {/* ── Hero ── */}
        <section className="py-16 md:py-28 flex flex-col md:flex-row items-center gap-12 md:gap-16">
          <motion.div
          ...
          >
            ...
            >
              A centralized hub for high-quality UserScripts. Built for maximum
              performance, long-term stability, and seamless browser
              integration.
            </motion.p>
            ...
            >
              <motion.a
                ...
                className="bg-gradient-to-r from-blue-600 to-blue-700 text-white px-8 py-3.5 rounded-xl font-bold shadow-lg shadow-blue-500/35 flex items-center cursor-pointer"
              ...
              <motion.a
                ...
                onClick={(e) => {
                  e.preventDefault();
                  scrollToSection("#install-guide");
                }}
                className="bg-slate-900/50 backdrop-blur hover:bg-slate-800 text-slate-300 px-8 py-3.5 rounded-xl font-bold transition border border-slate-800 flex items-center gap-2"
                whileHover={{ scale: 1.02 }}
                whileTap={{ scale: 0.98 }}
              >
                <Download size={15} />
                ...
                <div className="space-y-4">
                  {[
                    ...
                    <motion.div
                      ...
                      initial={{ width: 0 }}
                      animate={{ width: bar.w }}
                      transition={{ duration: 1, ease: "easeOut", delay: bar.delay }}
                    />
                  ))}
        ...
        <section id="directory" className="py-20 border-t border-slate-900">
          ...
          >
            <div>
              ...
              <p className="text-slate-500 text-sm">
                Official script repository and production builds.
              </p>
            </div>
          ...
          <AnimatePresence mode="wait">
            <motion.div
              key={activeTab}
              initial={{ opacity: 0, x: activeTab === "production" ? 80 : -80 }}
              animate={{ opacity: 1, x: 0 }}
              exit={{ opacity: 0, x: activeTab === "production" ? -80 : 80 }}
            ...
            >
              {activeTab === "production" && (
                <div className="grid grid-cols-1 gap-10">
                  {/* GeoGuessr Card */}
                  <motion.article
                    className="rounded-2xl overflow-hidden group border bg-slate-800/30 backdrop-blur-xl border-slate-700/50 hover:border-emerald-500/30 transition-all"
                    initial={{ opacity: 0, y: 20 }}
                    whileInView={{ opacity: 1, y: 0 }}
                    viewport={{ once: true }}
                    transition={{ duration: 0.5 }}
                    ...
                    <div className="bg-slate-900/60 px-6 py-5 border-b border-slate-800/50 flex flex-col sm:flex-row items-center justify-between gap-4">
                      <div className="flex items-center space-x-4">
                        <div className="relative w-12 h-12 flex-shrink-0">
                          <div className="absolute inset-0 bg-emerald-500/20 blur-lg rounded-xl opacity-0 group-hover:opacity-100 transition" />
                          <div className="relative w-12 h-12 rounded-xl overflow-hidden border border-emerald-500/30 bg-slate-900">
                            <img
                              ...
                              onError={(e) => {
                                (e.target as HTMLImageElement).src =
                                  "https://placehold.co/48x48/0f172a/10b981?text=GG";
                              }}
                            />
                          </div>
                        </div>
                      ...
                      <div className="flex items-center space-x-4">
                        <button
                          onClick={openModal}
                          className="text-xs font-bold text-emerald-400 hover:bg-emerald-400/10 px-4 py-2 rounded-lg transition border border-emerald-400/20 flex items-center gap-2"
                        >
                          <Book size={14} />
                          Guide
                        </button>
                    ...
                    <div className="overflow-x-auto">
                      <table className="w-full text-left text-sm">
                        <thead className="text-[10px] uppercase tracking-widest text-slate-500 bg-slate-950/40">
                          <tr>
                            <th className="px-6 py-4 font-bold border-b border-slate-800/50">
                              Build Name
                            </th>
                            <th className="px-6 py-4 font-bold border-b border-slate-800/50 hidden sm:table-cell">
                              Optimization
                            </th>
                            <th className="px-6 py-4 font-bold border-b border-slate-800/50 text-right w-36">
                              Deployment
                            </th>
                          </tr>
                        </thead>
                        <tbody className="divide-y divide-slate-800/30">
                          ...
                          >
                            <td className="px-6 py-4 font-mono text-emerald-400 font-medium text-xs">
                              v2.0.0-release.js
                            </td>
                            <td className="px-6 py-4 text-slate-400 text-xs hidden sm:table-cell">
                              Full location analysis with minimap overlay.
                            </td>
                  ...
                  {/* Chess.com Card */}
                  <motion.article
                    className="rounded-2xl overflow-hidden group border bg-slate-800/30 backdrop-blur-xl border-slate-700/50 hover:border-[#769656]/30 transition-all"
                    initial={{ opacity: 0, y: 20 }}
                    whileInView={{ opacity: 1, y: 0 }}
                    viewport={{ once: true }}
                  ...
                  >
                    <div className="bg-slate-900/60 px-6 py-5 border-b border-slate-800/50 flex flex-col sm:flex-row items-center justify-between gap-4">
                      <div className="flex items-center space-x-4">
                        <div className="relative w-12 h-12 flex-shrink-0">
                          <div className="absolute inset-0 bg-[#769656]/20 blur-lg rounded-xl opacity-0 group-hover:opacity-100 transition" />
                          <div className="relative w-12 h-12 rounded-xl overflow-hidden border border-[#769656]/30 bg-slate-900">
                            <img
                              ...
                              onError={(e) => {
                                (e.target as HTMLImageElement).src =
                                  "https://placehold.co/48x48/0f172a/769656?text=Chess";
                              }}
                            />
                          </div>
                        </div>
                    ...
                    <div className="overflow-x-auto">
                      <table className="w-full text-left text-sm">
                        ...
                        <tbody className="divide-y divide-slate-800/30">
                          <motion.tr
                            className="hover:bg-[#769656]/[0.05] transition-colors"
                            initial={{ opacity: 0 }}
                            animate={{ opacity: 1 }}
                            transition={{ delay: 0.1 }}
                          >
                            <td className="px-6 py-4 font-mono text-[#8fa866] font-medium text-xs">
                              v1.2.0-release.js
                            </td>
                            <td className="px-6 py-4 text-slate-400 text-xs hidden sm:table-cell">
                              Initial build for board detection and analysis.
                            </td>
                            <td className="px-6 py-4 text-right">
                              <a
                  ...
                  >
                    ...
                    <p className="text-slate-600 text-xs mt-1.5">
                      New scripts are currently under active development.
                    </p>
                  </motion.div>
                </div>
              )}
              ...
              {activeTab === "legacy" && (
                ...
                >
                  ...
                  <p className="text-slate-600 text-sm mt-2 max-w-xs">
                    Older script versions are not publicly available. Please
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-start">
            ...
            >
              <div>
                ...
                <p className="text-slate-400 leading-relaxed">
                  ...
                  <span className="text-blue-400 font-bold">
                    Standardized Script Schema (S3)
                  </span>
                  . We prioritize code security, runtime performance, and a
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                {[
                  ...
                  >
                    <div
                      className={`w-9 h-9 rounded-lg ${item.bg} flex items-center justify-center mb-4`}
                    >
            ...
            >
              ...
              <div className="p-6 text-[12px] font-mono leading-relaxed overflow-x-auto">
                {[
                  { ln: 1, content: <span className="text-slate-500"># Clone the repository</span> },
                  {
                    ln: 2,
                    content: (
                      <span className="text-blue-400">
                        ...
                        <span className="text-emerald-400">
                          &quot;https://github.com/JD-YH03D/Scripts&quot;
                        </span>
                      </span>
                    ),
                  },
                  ...
                  { ln: 4, content: <span className="text-slate-500"># Install dependencies and optimize</span> },
                  {
                    ln: 5,
                    content: (
                      <span className="text-blue-400">
                        npm <span className="text-slate-300">install</span> &&
                        npm <span className="text-slate-300">run optimize</span>
                      </span>
                    ),
                  },
                  {
                    ...
                    content: (
                      <span className="text-emerald-400 font-bold">
                        ...
                        <span className="text-slate-300 font-normal">
                          2 packages optimized.
                        </span>
                      </span>
                    ),
                  },
                ].map(({ ln, content }) => (
                  <div key={ln} className={`flex gap-4 ${ln < 6 ? "mb-1" : ""}`}>
                    <span className="text-slate-700 select-none w-4 text-right flex-shrink-0">
                      {ln}
                    </span>
                    <p>{content}</p>
                  </div>
        ...
        {/* ── Install Guide ── */}
        <section id="install-guide" className="py-24 border-t border-slate-900">
          <motion.div
          ...
          >
            ...
            <p className="text-slate-500 text-base max-w-xl mx-auto leading-relaxed">
              Follow this step-by-step guide to install Tampermonkey and deploy
              scripts from Greasy Fork in minutes.
            </p>
          </motion.div>
          ...
          <motion.div
            ...
            transition={{ duration: 0.5 }}
          >
            <div className="flex bg-slate-900/60 backdrop-blur p-1.5 rounded-2xl border border-slate-800 gap-1">
              <button
                onClick={() => setActiveInstallTab("tampermonkey")}
                className={`flex items-center gap-2.5 px-6 py-3 rounded-xl text-xs font-bold transition-all ${
                  activeInstallTab === "tampermonkey"
              ...
              <button
                onClick={() => setActiveInstallTab("greasyfork")}
                className={`flex items-center gap-2.5 px-6 py-3 rounded-xl text-xs font-bold transition-all ${
                  activeInstallTab === "greasyfork"
            ...
            >
                ...
                {currentSteps.map((s, i) => (
                  <div key={s.step} className="flex items-center flex-1">
                    <div className="flex flex-col items-center">
                      <motion.div
                        className={`w-9 h-9 rounded-full border-2 flex items-center justify-center text-xs font-black transition-all cursor-pointer ${
                          activeInstallTab === "tampermonkey"
                      ...
                      <span className="text-[9px] text-slate-600 mt-1 font-bold uppercase tracking-wider hidden sm:block text-center max-w-[60px] leading-tight">
                        Step {s.step}
                      </span>
                    </div>
              ...
              <div className="space-y-4">
                {currentSteps.map((step, i) => {
                  const isOpen = activeTutorialStep === i;
                  ...
                  return (
                    ...
                    >
                      <button
                        ...
                        onClick={() =>
                          setActiveTutorialStep(isOpen ? null : i)
                        }
                      ...
                      >
                        ...
                        {/* Icon */}
                        <div
                          className={`flex-shrink-0 w-10 h-10 rounded-xl flex items-center justify-center border ${step.bg} ${step.border}`}
                        >
                      ...
                      <AnimatePresence initial={false}>
                        {isOpen && (
                          ...
                          >
                            <div className="px-6 pb-6 pt-0 ml-[4.75rem]">
                              <div
                                className={`h-px mb-5 ${
                                  activeInstallTab === "tampermonkey"
                                    ? "bg-amber-500/10"
                              ...
                              {step.link && (
                                <a
                                  ...
                                  target="_blank"
                                  rel="noopener noreferrer"
                                  className={`inline-flex items-center gap-2 text-xs font-bold px-4 py-2.5 rounded-lg border transition-all ${
                                    activeInstallTab === "tampermonkey"
              ...
              {/* Bottom CTA */}
              <motion.div
                className="mt-10 p-6 rounded-2xl border border-slate-800 bg-slate-900/30 flex flex-col sm:flex-row items-center gap-5"
                initial={{ opacity: 0, y: 20 }}
                whileInView={{ opacity: 1, y: 0 }}
                viewport={{ once: true }}
                transition={{ delay: 0.3 }}
              >
                <div className="flex-shrink-0 h-12 w-12 rounded-xl bg-gradient-to-br from-blue-600/30 to-purple-600/30 border border-blue-500/20 flex items-center justify-center">
                ...
                <div className="flex-1 text-center sm:text-left">
                  ...
                  <p className="text-slate-500 text-xs mt-0.5">
                    Head to the Directory section above and click any{" "}
                    <span className="text-emerald-400 font-bold">Install</span>{" "}
                ...
                <a
                  ...
                  className="flex-shrink-0 bg-gradient-to-r from-blue-600 to-blue-700 text-white px-6 py-2.5 rounded-xl text-xs font-bold transition hover:from-blue-500 hover:to-blue-600 flex items-center gap-2 shadow-lg shadow-blue-500/20"
                >
                  View Scripts
              ...
              >
                {[
                  { name: "Chrome", color: "text-yellow-400", icon: "🟡" },
                  { name: "Firefox", color: "text-orange-400", icon: "🦊" },
                  { name: "Edge", color: "text-blue-400", icon: "🔵" },
                  { name: "Opera", color: "text-red-400", icon: "🔴" },
                ].map((b) => (
                  <div
                    key={b.name}
                    className="flex items-center gap-2.5 bg-slate-900/50 border border-slate-800 rounded-xl px-4 py-3"
                  >
                    ...
                    <div>
                      ...
                      <p className="text-[10px] text-slate-600">Supported</p>
                    </div>
                  </div>
                ))}
              </motion.div>
          ...
          <div className="flex flex-col md:flex-row justify-between items-center gap-8">
            <div className="text-center md:text-left">
              ...
              <p className="text-slate-600 text-xs font-medium">
                © 2024 JD-YH03D. Released under the MIT License.
              </p>
